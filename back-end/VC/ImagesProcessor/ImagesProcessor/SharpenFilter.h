...
/**
 * @brief A filter that applies a sharpen effect to an image.
 *
 * This class implements the IFilter interface to provide a sharpen effect
 */
class SharpenFilter : public IFilter
{
public:
	/**
	 * @brief Applies the sharpen filter to an image.
	 *
	 * This method applies a horizontal and vertical sharpen pass to the input image
